...
export const sceneRegistry: Record<Exclude<SceneId, 'ending'>, SceneRecord> = {
  ...
  service: {
    id: 'service',
    aria: 'Pasillo de servicio con humedad, caños expuestos, puerta hacia el pasillo principal, rejilla alta, plano bajo pintura y panel falso.',
  ...
  hidden: {
    id: 'hidden',
    aria: 'Hueco detrás del pasillo de servicio con estantes angostos, cajas, marcas a lápiz y una abertura iluminada hacia el pasillo.',
    ...
    hotspots: [
      ...
      {
        id: 'return-notebook',
        label: 'mesa baja del hueco',
        verb: 'dejar cuaderno y abrir puerta',
        rect: { x: 45, y: 70, w: 23, h: 19 },
